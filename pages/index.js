...
export default function Home() {
  ...
  const galleryPhotos = Array.from(
    { length: 51 },
    (_, index) => `/images/living-room-gallery/${index + 1}_Photo_Gallery.png`
  );
      ...
      <main>
        ...
        <section className="page-shell intro-layout">
          ...
          <aside className="booking-card">
            ...
            <a href="mailto:info@elevatedstayscolorado.com" className="secondary-button">
              Ask a Question
            </a>
        ...
        <section className="final-cta">
          <div className="page-shell">
            ...
            <a href="https://www.airbnb.com/h/the-living-room" className="primary-button light">
              Book Your Stay
            </a>
          </div>
        </section>
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="The Living Room by Elevated Stays Colorado is a private luxury spa retreat in Divide, Colorado with a hot tub, sauna, mountain views, fireplace, and peaceful couples-focused experience."
        />
      </Head>
